...
class DoubleExposureTestCase(unittest.TestCase):
    ...
    def test_alpha_half(self) -> None:
        ...
        self.assertEqual(result_image.size, (450, 450))

        # Check if the result image matches a blend of the two images
        expected_image = Image.new("RGB", (450, 450), (127, 127, 0))
    ...
    def test_alpha_zero(self) -> None:
        ...
        image1 = Image.new("RGB", (450, 450), (255, 0, 0))  # Red
        image2 = Image.new("RGB", (450, 450), (0, 255, 0))  # Green
