...
from gui.modules import DECRYPTCOL, dynamic_menu_bar, key_popup
...
class DecryptWin(Frame):
    ...
    def __init__(self, root, object, decoded_text):
        ...
        # create window
        super().__init__(root, bg=DECRYPTCOL)
        ...
        # split layout
        self.mainframe = Frame(self, bg=DECRYPTCOL)
        self.text = Text(
            self.mainframe,
            width=30,
            height=15,
        ...
        self.key_status = Label(self, textvariable=self.key, bg=DECRYPTCOL, fg="white")
    ...
    def edit_key(self):
        ...
        key_popup(self.root, self.root.decrypt)
